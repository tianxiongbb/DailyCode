...
##help document##
if len(sys.argv)<2:
	print "usage: get piRNA signal from every feature in in.txt"
	print "python Apr21_GetpiRNASignal.py in.txt out.txt featureList"
	print "\033[1;31;38m"
	print "="*50
	print "\033[0m"
	os._exit(0)
...
while True:
	...
	if not l:
		break
	d_out[l[10]]+=float(l[3])/float(l[4])
