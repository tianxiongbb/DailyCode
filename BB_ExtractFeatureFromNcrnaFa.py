...
if len(sys.argv)<2:
	print "usage:"
	print "BB_ExtractFeatureFromNcRNAFa.py ncRNA.fa out.fa feature"
	print ""
	print "feature must be split with ,-----for example miRNA,snRNA,rRNA"
	print ""
	print "\033[1;31;38m"
	print "="*50
	print "\033[0m"
...
print "there are %s features in ncRNA.fa"%n
