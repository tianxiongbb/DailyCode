...
if len(sys.argv)<2:
	print "usage:"
	print "python BB_MergeBlastResult.py result1 result2 out.name"
	print "\033[1;31;38m"
	print "="*50
	print "\033[0m"
	os._exit(0)
...
##run##
f_r1=open(sys.argv[1],"r")
f_r2=open(sys.argv[2],"r")
f_out=open(sys.argv[3],"w")
d_r1={}
l_out=[]

while True:
	line=f_r1.readline().split()
	if not line:
		break
	d_r1[line[0]]=line[1]
...
while True:
	...
	if not line:
		break
	if d_r1.has_key(line[1]):
		if d_r1[line[1]]==line[0]:
			l_out.append(line)
